...
class Estimation {
    async sdk({ request, response, params }) {
        ...
        estimationModel.domains = [ "internetx.com", "example.com" ]
        estimationModel.currency = "EUR"
        ...
        try {
            ...
            let domainRobotResult = await domainRobot.pcDomains().estimation(estimationModel)
