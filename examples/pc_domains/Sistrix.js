...
class Sistrix {
    async sdk({ request, response, params }) {
        ...
        let domain = "internetx.com"; // Name of the Domain to check
        let country = "de"; // Country ISO Code
        ...
        try {
            ...
            const domainRobotResult = await domainRobot.pcDomains().sistrix(domain, country)
